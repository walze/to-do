...
export class Tables1593025870472 implements MigrationInterface {
    name = 'Tables1593025870472'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `todo` (`id` int NOT NULL AUTO_INCREMENT, `content` varchar(255) NOT NULL, `created_at` datetime NOT NULL, `updated_at` datetime NOT NULL, `userId` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
